...
class Fornecedor(models.Model):
    ...
    tipo_fornecedor = models.CharField('Tipo fornecedor *', max_length=10, choices=FORNECEDOR_TIPO, help_text='* Campo obrigatório')
 ...
 #      unique_together     =   [#chaves primarias]
        verbose_name        =   'fornecedor'
        verbose_name_plural =   'fornecedors'

    def __str__(self):
        return '%s - %s. %s' % (self.cnpj, self.nome,self.tipo_forcedor)
